...
- **misc**: Handling unknown error ([e503d1f](https://github.com/lobehub/chat-plugins-gateway/commit/e503d1f))
...
## [Version 1.8.0](https://github.com/lobehub/chat-plugins-gateway/compare/v1.7.2...v1.8.0)
...
- **misc**: Support node runtime, closes [#9](https://github.com/lobehub/chat-plugins-gateway/issues/9) ([28ef918](https://github.com/lobehub/chat-plugins-gateway/commit/28ef918))
...
- **misc**: Support basic auth for OpenAPI ([d3fe874](https://github.com/lobehub/chat-plugins-gateway/commit/d3fe874))
...
- **misc**: Update lint ([6385312](https://github.com/lobehub/chat-plugins-gateway/commit/6385312))
...
- **misc**: 移除跨域限制，解决插件复用的问题 ([975b705](https://github.com/lobehub/chat-plugins-gateway/commit/975b705))
...
- **misc**: Change master to main ([134c77f](https://github.com/lobehub/chat-plugins-gateway/commit/134c77f))
